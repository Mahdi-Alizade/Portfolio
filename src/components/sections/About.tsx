      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            {/* جایگزین این با عکس واقعی: img src="/me.jpg" ... */}
            <img 
              src="https://images.unsplash.com/photo-1507238691140-d48db37506ef?q=80&w=800&auto=format&fit=crop" 
              alt="Mahdi Alizade" 
              className="relative w-full h-[400px] object-cover rounded-lg grayscale hover:grayscale-0 transition-all duration-500 border border-white/10"
            />
          </div>

          {/* Content Side */}
          <div className="space-y-6">
            <div className="inline-block px-3 py-1 rounded-full border border-slate-700 text-xs font-medium text-slate-400 mb-2">
              About Me
            </div>
            ...
            <div className="flex flex-wrap gap-3 pt-4">
               {['Next.js', 'TypeScript', 'NestJS', 'React'].map((tech) => (
                 <span key={tech} className="px-3 py-1 bg-slate-900 rounded text-sm text-emerald-400 border border-slate-800">
                   {tech}
                 </span>
               ))}
            </div>
